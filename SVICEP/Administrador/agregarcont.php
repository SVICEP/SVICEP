...
<div class="stdr">
		...
		<div class="d-flex flex-column col-auto flex-shrink-0 p-3 text-white bg-dark min-vh-100" style="width: 270px;">
		    ...
		    <ul class="nav nav-pills flex-column mb-auto">
		      ...
		      <li>
		        <a href="agregarcont.php" class="nav-link active">
		          <svg class="bi me-2" width="16" height="16"></svg>
		          Agregar Registro
		        </a>
		      </li>
		      <li>
		        <a href="editarcont.php" class="nav-link text-white">
		          <svg class="bi me-2" width="16" height="16"></svg>
		           Editar Registro
		        </a>
		      </li>
	...
	<div class="d-flex flex-column col-auto pad col-5">
        <h4 class="mb-3 txwhite">Agregar contenido de prodcutos afectados por cambio climatico a la pagina</h4>
    	...
    	<table class="table table-dark table-striped">
  			<thead class="table-dark">
   				<tr>
   					...
   					<th scope="col"> Año </th>
            <th scope="col"> Cantidad en quintales </th>
   				</tr>
  			</thead>
  			<tbody>
    			<tr>
